...
public class EnhanceScrollView : MonoBehaviour
{
    ...
    [Tooltip("The Start center index")] public int startCenterIndex = 0;
    ...
    [Tooltip("Camera for drag ray cast")] public Camera sourceCamera;
    ...
    public void UpdateEnhanceScrollView(float fValue)
    {
        for (int i = 0; i < listEnhanceItems.Count; i++)
        {
            ...
            itemScript.UpdateScrollViewItems(xValue, depthCurveValue, depthFactor, listEnhanceItems.Count,
                yFixedPositionValue, scaleValue);
        }
    }
